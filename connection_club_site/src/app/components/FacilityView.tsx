      ...
      <div className="max-w-6xl w-full">
        ...
        <div className="relative w-full h-[500px]" style={{ perspective: '1200px' }}>
          ...
          <motion.div
            ...
            style={{ transformStyle: 'preserve-3d' }}
          >
            <div className="size-full bg-gradient-to-br from-slate-800/90 to-slate-900/90 backdrop-blur-sm border border-purple-500/30 rounded-2xl overflow-hidden shadow-2xl shadow-purple-500/20">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/90 to-transparent">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-sm text-purple-400">Main Experience</span>
                </div>
          ...
          <motion.div
            ...
            className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-0.5 bg-gradient-to-r from-cyan-500 via-blue-500 to-purple-500"
          >
